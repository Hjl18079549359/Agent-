...
import random
from Agent智能体.agent项目.utils.config_handler import agent_config
from Agent智能体.agent项目.utils.path_tool import get_abs_path
from Agent智能体.agent项目.utils.logger_handler import logger
from Agent智能体.agent项目.rag.rag_service import RagSummarizeService
...
if __name__ == '__main__':
    print(fetch_external_data("1025", "2025-02"))